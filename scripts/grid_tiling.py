...
def download_sentinel2_rgb( bbox, output_file = "sentinel2_rgb.png", width = 1024, height = 1024, client_id = None, client_secret = None, maxcc = 0.2):
    """
...
############################################################################
# The following functions are for tiling the downloaded images and computing statistics on the tiles.
############################################################################
